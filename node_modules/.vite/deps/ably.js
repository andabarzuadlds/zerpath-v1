    ...
    (function(g, f) {
      ...
      var _Logger = class _Logger2 {
        constructor() {
          ...
          this.logLevel = _Logger2.defaultLogLevel;
          this.logHandler = _Logger2.defaultLogHandler;
          this.logErrorHandler = _Logger2.defaultLogErrorHandler;
        }
        static initLogHandlers() {
          ...
          this.defaultLogger = new _Logger2();
        }
        /**
        ...
        logAction(level, action, message) {
          if (this.shouldLog(level)) {
            (level === 1 ? this.logErrorHandler : this.logHandler)("Ably: " + action + ": " + message, level);
          }
        }
        ...
        deprecationWarning(message) {
          if (this.shouldLog(
            ...
            this.logErrorHandler(
              `Ably: Deprecation warning - ${message}`,
              1
              /* Error */
            );
          }
      ...
      var HttpStatusCodes = ((HttpStatusCodes2) => {
      ...
      var _PushChannelSubscription = class _PushChannelSubscription2 {
        /**
        ...
        static fromResponseBody(body, MsgPack, format) {
          ...
          if (Array.isArray(body)) {
            return _PushChannelSubscription2.fromValuesArray(body);
          } else {
            return _PushChannelSubscription2.fromValues(body);
          }
        }
        static fromValues(values) {
          return Object.assign(new _PushChannelSubscription2(), values);
        }
        static fromValuesArray(values) {
          const count = values.length, result = new Array(count);
          for (let i = 0; i < count; i++)
            result[i] = _PushChannelSubscription2.fromValues(values[i]);
          return result;
        }
      };
      ...
      var Admin = class {
        ...
        async publish(recipient, payload) {
          const client = this.client;
          const format = client.options.useBinaryProtocol ? "msgpack" : "json", headers = defaults_default.defaultPostHeaders(client.options, { format }), params = {};
      ...
      var DeviceRegistrations = class {
        ...
        async get(deviceIdOrDetails) {
          const client = this.client, format = client.options.useBinaryProtocol ? "msgpack" : "json", headers = defaults_default.defaultGetHeaders(client.options, { format }), deviceId = deviceIdOrDetails.id || deviceIdOrDetails;
        ...
        async list(params) {
          const client = this.client, format = client.options.useBinaryProtocol ? "msgpack" : "json", envelope = this.client.http.supportsLinkHeaders ? void 0 : format, headers = defaults_default.defaultGetHeaders(client.options, { format });
          mixin(headers, client.options.headers);
        ...
        async remove(deviceIdOrDetails) {
          const client = this.client, format = client.options.useBinaryProtocol ? "msgpack" : "json", headers = defaults_default.defaultGetHeaders(client.options, { format }), params = {}, deviceId = deviceIdOrDetails.id || deviceIdOrDetails;
          if (typeof deviceId !== "string" || !deviceId.length) {
            throw new ErrorInfo(
      ...
      var RestPresence = class {
        ...
        async get(params) {
          ...
          const client = this.channel.client, format = client.options.useBinaryProtocol ? "msgpack" : "json", envelope = this.channel.client.http.supportsLinkHeaders ? void 0 : format, headers = defaults_default.defaultGetHeaders(client.options, { format });
          mixin(headers, client.options.headers);
      ...
      var RestChannel = class {
        ...
        async publish(...args) {
          ...
          const client = this.client, options = client.options, format = options.useBinaryProtocol ? "msgpack" : "json", idempotentRestPublishing = client.options.idempotentRestPublishing, headers = defaults_default.defaultPostHeaders(client.options, { format });
      ...
      var RestChannelMixin = class {
        ...
        static history(channel, params) {
          const client = channel.client, format = client.options.useBinaryProtocol ? "msgpack" : "json", envelope = channel.client.http.supportsLinkHeaders ? void 0 : format, headers = defaults_default.defaultGetHeaders(client.options, { format });
          mixin(headers, client.options.headers);
      ...
      var RestPresenceMixin = class {
        ...
        static async history(presence, params) {
          const client = presence.channel.client, format = client.options.useBinaryProtocol ? "msgpack" : "json", envelope = presence.channel.client.http.supportsLinkHeaders ? void 0 : format, headers = defaults_default.defaultGetHeaders(client.options, { format });
          mixin(headers, client.options.headers);
          return new paginatedresource_default(
            client,
      ...
      var Rest = class {
        ...
        async batchPublish(specOrSpecs) {
          ...
          const format = this.client.options.useBinaryProtocol ? "msgpack" : "json", headers = defaults_default.defaultPostHeaders(this.client.options, { format });
          if (this.client.options.headers)
            mixin(headers, this.client.options.headers);
      ...
      var RestAnnotations = class {
        ...
        async publish(msgOrSerial, annotationValues) {
          ...
          const client = this.channel.client, options = client.options, format = options.useBinaryProtocol ? "msgpack" : "json", headers = defaults_default.defaultPostHeaders(client.options, { format }), params = {};
          mixin(headers, client.options.headers);
        ...
        async get(msgOrSerial, params) {
          const client = this.channel.client, messageSerial = serialFromMsgOrSerial(msgOrSerial), format = client.options.useBinaryProtocol ? "msgpack" : "json", envelope = client.http.supportsLinkHeaders ? void 0 : format, headers = defaults_default.defaultGetHeaders(client.options, { format });
          mixin(headers, client.options.headers);
          return new paginatedresource_default(
            client,
      ...
      var _DefaultRest = class _DefaultRest2 extends BaseRest {
        ...
        constructor(options) {
          var _a2, _b;
          const MsgPack = _DefaultRest2._MsgPack;
          if (!MsgPack) {
          ...
          super(
            defaults_default.objectifyOptions(options, true, "Rest", logger_default.defaultLogger, __spreadProps(__spreadValues({}, allCommonModularPlugins), {
              Crypto: (_a2 = _DefaultRest2.Crypto) != null ? _a2 : void 0,
              MsgPack: (_b = _DefaultRest2._MsgPack) != null ? _b : void 0,
              Annotations: {
      ...
      var _BaseRealtime = class _BaseRealtime2 extends baseclient_default {
        /*
         * The public typings declare that this only accepts an object, but since we want to emit a good error message in the case where a non-TypeScript user does one of these things:
         *
         * 1. passes a string (which is quite likely if they’re e.g. migrating from the default variant to the modular variant)
        ...
        constructor(options) {
          ...
          this._additionalTransportImplementations = _BaseRealtime2.transportImplementationsFromPlugins(this.options.plugins);
      ...
      var _DefaultRealtime = class _DefaultRealtime2 extends baserealtime_default {
        // The public typings declare that this requires an argument to be passed, but since we want to emit a good error message in the case where a non-TypeScript user does not pass an argument, tell the compiler that this is possible so that it forces us to handle it.
        constructor(options) {
          var _a2;
          const MsgPack = _DefaultRealtime2._MsgPack;
          if (!MsgPack) {
          ...
          super(
            defaults_default.objectifyOptions(options, true, "Realtime", logger_default.defaultLogger, __spreadProps(__spreadValues({}, allCommonModularPlugins), {
              Crypto: (_a2 = _DefaultRealtime2.Crypto) != null ? _a2 : void 0,
              MsgPack,
              RealtimePresence: {
